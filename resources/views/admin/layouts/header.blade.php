            <div class="header">
				...
				<ul class="nav user-menu">
                    <a class="btn btn-outline-dark p-3 mr-5" target="0" href="{{ route('blog') }}"><i class="fa fa-home"></i>Home</a>
					<!-- Notifications -->
					...
					<li class="nav-item dropdown has-arrow">
						<a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown"aria-expanded="false">
							<span class="user-img"><img class="rounded-circle" src="admin/assets/img/profiles/avatar-01.jpg" width="31" alt="{{ Auth::user() -> name}}"></span>
						</a>
