  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      	...
      	<form id="edit_post_form" action="{{-- {{ route('tag.update') }} --}}" method="POST">
      		@csrf

        <div class="form-group">
			<label>Post Format</label>
             <button  id="feat_btn" disabled name="featured" class="btn btn-primary btn-block"></button>
		</div>

		<div class="form-group">
			<label>Select Post Category</label>
{{--       <select class="custom-select mr-sm-2" id="edit_post_cat_id" name="category">

        <option selected="" id="selected_id"></option>

      </select> --}}

        <button  id="feat_btn_cat" disabled name="cat_frick" class="btn btn-primary btn-block"></button>
